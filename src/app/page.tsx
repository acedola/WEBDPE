...
export default function Home() {
  return (
    <>
      ...
      >
        <div className="card-container shadow hover">
          <a href="http://www.desa.estadistica.ec.gba.gov.ar/censos/36/secciones/censo2022">
        ...
        <div className="card-container shadow hover">
          <a href="http://www.desa.estadistica.ec.gba.gov.ar/estadisticas/29">
            <div className="flex justify-center items-center">
        ...
        <div className="card-container shadow hover">
          <a href="http://www.desa.estadistica.ec.gba.gov.ar/estadisticas/5">
            <div className="flex justify-center items-center">
	...
	<section className="calendario-boton-genero">
            <a href="/../pdf/Censo2022_Resultados_por_municipio.pdf" target="_blank" className="boton-censo">
              <Image
                className="censo"
        ...
        <div className="container-2">
          ...
          <div className="botonesNuevos">
            <div className="btnNuevo bg-transparent text-blue-700 font-semibold py-2 px-4 border hover:border-transparent rounded text-center ">
              <a href="https://www.desa.estadistica.ec.gba.gov.ar/censos/36/secciones/censo%202022">
                CENSO 2022
              </a>
            </div>
            ...
            <div className="btnNuevo bg-transparent text-blue-700 font-semibold py-2 px-4 border hover:border-transparent rounded text-center  ">
              <a href="revista" target="_blank">
                REVISTA ESTUDIOS DE POBLACION
              </a>
            </div>
            <div className="btnNuevo bg-transparent text-blue-700 font-semibold py-2 px-4 border hover:border-transparent rounded text-center  ">
              <a href="http://www.desa.estadistica.ec.gba.gov.ar/estadisticas/13" target="_blank">
            ...
            <div className="btnNuevo bg-transparent text-blue-700 font-semibold py-2 px-4 border hover:border-transparent rounded text-center  ">
              <a href="http://www.desa.estadistica.ec.gba.gov.ar/estadisticas/42" target="_blank">
      ...
      <section className="botones">
        <a className="item-g" href="/prensa">
          PRENSA
        </a>
        <a className="item-a" href="/anuarios">
          ANUARIOS
        </a>
        <a className="item-b" href="https://datos.estadistica.ec.gba.gov.ar/dataset/datos-basicos" target="_blank">
          DATOS BÁSICOS
        </a>
